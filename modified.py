...
api_id = os.environ.get("API_ID", 19454686)
api_hash = os.environ.get("API_HASH", "222b343adf676a4f89adbe62679c815d")
session_string = os.environ.get("STRING_SESSION", "1ApWapzMBu7Cex3fYnh5queHcFBFsy9bTUZ9aMgvDoJoTL-bngWYQJA6JtvUrpbA3i8BAGqZyBO8TQ3BUOUynbRN4qlFVe0xgkj2Qx2UDldfa9_dce-pbqsJXwSKePtpiZd4wKGuPUJ5xxMVAPO-A515OuOIm2VYmrF6WSzwtqi3o8wlCWVJOpPFV3fDyYa2N5gY4UQfq9bUEZQCNNtKjacwiCqF_enFsvd26jTVoaJWTs4TReGaV7iEhM8e0uTD5oMQolwpBK6TvdSucugsINoQaLPVwi5pJMCeWt-b0t9-CMUaAk5U0d6J1qXSrWdluI6mfhymhQGhIr826z_GALiBEYJmlKxQ=")
...
async def _(event):
    ...
    async with event.client.conversation(chat) as conv:
          try:     
              response = conv.wait_event(events.NewMessage(incoming=True,from_users=1260465030))
...
JOKER_ID = {1260465030: 5, 1260465030: 3}  
aljoker_enabled = True  
...
R = [
    ...
    "**-** قناة السورس **⪼ [𐇮 FLEX ](t.me/Tepthon)   "
]

DevJoker = [1260465030, 1260465030]  
...
check_message = """
 𓆩 𝗦𝗢𝗨𝗥𝗖𝗘 𝗧𝗘𝗣𝗧𝗛𝗢𝗡 𓆪
✦ [ 🤍 ] الاســم : {mention}
✦ [ ⚙️ ] اصــدار بـايـثــون : {python_version}
✦ [ 🔧 ] اصــدار تـلـيـثـون : {telethon_ver}
✦ [ 📡 ] الــبــنــق : {ping_result} ms
✦ [ ⏲️ ] مـدة الـتـشـغـيـل : {uptime}
✦ [ 🗓️ ] تـاريـخ الـتـنـصـيـب : {setup_date_str}
...
async def permalink(event):
    ...
    blocked_ids = [1260465030, 1260465030]  
...
CHANNELS_STR = f"𓆩 **[𝗦𝗢𝗨𝗥𝗖𝗘 𝗧𝗘𝗣𝗧𝗛𝗢𝗡](t.me/Tepthon)** **- 🝢 - احصـائيـات جميـع القنـوات** 𓆪\n\n"
CHANNELS_ADMINSTR = f"𓆩 **[𝗦𝗢𝗨𝗥𝗖𝗘 𝗧𝗘𝗣𝗧𝗛𝗢𝗡](t.me/Tepthon)** **- 🝢 - احصـائيـات جميـع القنـوات اشـراف** 𓆪\n\n"
CHANNELS_OWNERSTR = f"𓆩 **[𝗦𝗢𝗨𝗥𝗖𝗘 𝗧𝗘𝗣𝗧𝗛𝗢𝗡](t.me/Tepthon)** **- 🝢 - احصـائيـات جميـع القنـوات ملكيـة** 𓆪\n\n"
GROUPS_STR = f"𓆩 **[𝗦𝗢𝗨𝗥𝗖𝗘 𝗧𝗘𝗣𝗧𝗛𝗢𝗡](t.me/Tepthon)** **- 🝢 - احصـائيـات جميـع المجمـوعـات** 𓆪\n\n"
GROUPS_ADMINSTR = f"𓆩 **[𝗦𝗢𝗨𝗥𝗖𝗘 𝗧𝗘𝗣𝗧𝗛𝗢𝗡](t.me/Tepthon)** **- 🝢 - احصـائيـات جميـع المجمـوعـات اشـراف** 𓆪\n\n"
GROUPS_OWNERSTR = f"𓆩 **[𝗦𝗢𝗨𝗥𝗖𝗘 𝗧𝗘𝗣𝗧𝗛𝗢𝗡](t.me/Tepthon)** **- 🝢 - احصـائيـات جميـع المجمـوعـات ملكيـة** 𓆪\n\n"
...
async def count(event):
    ...
    for d in dialogs:
        ...
        if isinstance(current_entity, User):
            ...
            print(d)
    result += f"ـ𓆩 ᯓ𝗦𝗢𝗨𝗥𝗖𝗘 𝗧𝗘𝗣𝗧𝗛𝗢𝗡 **- 🝢 - احصـائيـات الحسـاب** 𓆪\n"
...
async def stats(event):
    ...
    response = f"ـ𓆩 𝗦𝗢𝗨𝗥𝗖𝗘 𝗧𝗘𝗣𝗧𝗛𝗢𝗡**- 🝢 - معلومات {full_name}** 𓆪\n"
...
async def kashf(event):
    ...
    rotbat = "⌁ مطور السورس الرسمي 𓄂𓆃 ⌁" if user_id == 1260465030 else ("⌁ العضـو 𓅫 ⌁")
...
OWNER_ID = 1260465030  # ضع معرفك هنا
...
OWNER_ID = 1260465030  # ضع هنا معرف المالك الحقيقي
...
async def show_commands(event):
    commands_text = """ 
[𓆩⟦ ✦ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗧𝗘𝗣𝗧𝗛𝗢𝗡 ✦ ⟧𓆪](https://t.me/Tepthon)
⋆ ── • ── ⋆ ── • ── ⋆ ── • ── ⋆
قـائـمـة الأوامـر ⟧𓆪
⋆ ── • ── ⋆ ── • ── ⋆ ── • ── ⋆

✦ .م1 ➪ 『 أوامــر الــخــاص 』
✦ .م2 ➪ 『 أوامــر الــردود 』
✦ .م3 ➪ 『 أوامــر نــشــر الــتـلـقـائـي 』
✦ .م4 ➪ 『 أوامــر الــحــســاب 』
✦ .م5 ➪ 『 أوامــر الــتــسـلـيــة 』
✦ .م6 ➪ 『 أوامــر وعــد 』
✦ .م7 ➪ 『 أوامــر الــيــوتــيــوب 』
✦ .م8 ➪ 『 أوامــر الــمــجــمــوعـات 』
✦ .م9 ➪ 『 أوامـر تجــمــيــع تـلـقـائـي 』
✦ .م10 ➪ 『 أوامــر الـخطـوط والترجمة 』
✦ .م11 ➪ 『 أوامــر التنصيب الخارجي 』
✦ .م12 ➪ 『 أوامــر الــمــغـادرات 』
✦ .م13 ➪ 『 أوامــر الـذاتيــة 』
✦ .م14 ➪ 『 أوامــر الاضـافـة 』
✦ .م15 ➪ 『 أوامــر الـتـحـويـل 』
✦ .م16 ➪ 『 أوامــر اخـرى 』
✦ .م17 ➪ 『 أوامــر الـذكــاء الاصـطـنـاعـي 』
✦ .م18 ➪ 『 أوامــر عرض القنوات 』
✦ .م19 ➪ 『 أوامــر الـزخـرفـة 』
✦ .م20 ➪ 『 أوامــر اضـافـيـة 』
✦ .م21 ➪ 『 أوامــر 2 الـتـسـلـيـه 』
✦ .م22 ➪ 『 أوامــر الـمـيـمـز 』
✦ .م23 ➪ 『 أوامــر الـتـقـلـيـد والـنـتـحـال 』
✦ .م24 ➪ 『 أوامــر الـتـحــشــيــش 』
✦ .م25 ➪ 『 أوامــر صـيـد الـيـوزرات 』
✦ .م26 ➪ 『 أوامــر الـتـثـبـيـت 』

⋆ ── • ── ⋆ ── • ── ⋆ ── • ── ⋆
[𓆩⟦ ✦ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗧𝗘𝗣𝗧𝗛𝗢𝗡 - قـنـاة الـسـورس ✦ ⟧𓆪](https://t.me/Tepthon)
"""
...
⋆┄─┄─┄─┄┄─┄─┄─┄─┄┄⋆
ᯓ[𝗦𝗢𝗨𝗥𝗖𝗘 𝗧𝗘𝗣𝗧𝗛𝗢𝗡-قناة السورس](https://t.me/Tepthon) ᯓ
"""
...
@client.on(events.NewMessage(outgoing=True, pattern=".اعادة تشغيل"))
async def restart_tepthon(event):
    await event.edit("🔄 جارٍ إعادة تشغيل سورس TEPTHON ...")
    await asyncio.sleep(2)
...
async def send_welcome_message(event):
    await event.delete()
    welcome_message = """
- سـورس تيبثــون العربــي من أقدم السـورسات على تليجـرام ♥️

- أكثـر السورسات تنصيبًا وفعاليـة 

- يوزر بوت بمعنى الكلمـة
